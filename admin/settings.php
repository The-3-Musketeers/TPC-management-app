<?php
  ...
  if(isset($_POST['change_password'])){
    ...
    $query = "SELECT username FROM students WHERE roll_number='admin' && password='$current_password'";
    ...
    if(mysqli_num_rows($confirm_admin_query) == "1"){
      ...
      $query = "UPDATE students SET password='$new_password' WHERE roll_number='admin'";
